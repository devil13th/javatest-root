...
public class Test04 extends ActivitiTestCase{
	
	private String bk = "20171123-42";
	...
	public void test01deploy() throws Exception{
		Deployment deployment = this.util.deploy("com/thd/activiti/gateway/test04.bpmn");
	...
	public void test02beginProcess() throws Exception{
		...
		ProcessInstance processInstance = util.getRuntimeService().startProcessInstanceByKey("gatewaytest04",jobno,map);
	...
	public void test03completeTask() throws Exception{
		...
		String t3 = "t3";
		String t4 = "t4";
		util.claimAndComplateTask("177503", t3, null);
	}
