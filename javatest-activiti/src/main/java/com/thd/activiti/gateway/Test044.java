...
public class Test044 extends ActivitiTestCase{
	
	private String bk = "20171123-b";
	...
	public void test01deploy() throws Exception{
		Deployment deployment = this.util.deploy("com/thd/activiti/gateway/test044.bpmn");
	...
	public void test02beginProcess() throws Exception{
		...
		ProcessInstance processInstance = util.getRuntimeService().startProcessInstanceByKey("gatewaytest044",jobno,map);
	...
	public void test03completeTask() throws Exception{
		...
		String t3 = "t3";
		String t4 = "t4";
		util.claimAndComplateTask("217505", t4, null);
	}
