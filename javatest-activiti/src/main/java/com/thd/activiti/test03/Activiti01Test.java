...
public class Activiti01Test extends TestCase{
	...
	public void test01deployprocess() throws Exception{
		String deploymentId = repositoryService
				.createDeployment()
				.addClasspathResource("com/thd/activiti/test03/rute01.bpmn")
				.deploy()
				.getId();
	...
	public void test02beginprocess() throws Exception{
		...
		ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("rute01");
		System.out.println("已成功开启 rote01 流程：" );
