...
public class Test06a {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println("1.是否停止？"  + Thread.currentThread().interrupted());//所指的是main线程是否标记停止状态  --true
		System.out.println("2.是否停止？"  + Thread.currentThread().interrupted());//所指的是main线程是否标记停止状态  --true
