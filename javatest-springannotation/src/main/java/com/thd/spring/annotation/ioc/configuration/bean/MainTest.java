...
import com.thd.spring.annotation.ioc.configuration.other.OtherPackageBean;
...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		Fruit fruit = (Fruit)applicationContext.getBean("com.thd.spring.annotation.ioc.configuration.bean.Fruit");
